...
function RoleCard({ role, selectedRole, onClick, icon, title, description, id, iconBg }: RoleCardProps) {
  ...
  return (
    <button
      ...
      className={`relative flex w-1/2 flex-col items-center rounded-xl border-2 px-4 py-4 transition-all duration-200 cursor-pointer ${
        isSelected
          ? 'border-[#52B69A] bg-[#E6F5ED]'
          : 'border-[#E0E2E5] bg-white hover:border-[#52B69A]/40'
      }`}
    >
      {isSelected && (
