 ...
 *
 * ★ แสดงทุกช่องเสมอ รวมช่องที่ผู้จองไม่ได้กรอก (ขึ้นเป็น "—") เพราะในป๊อปอัปนี้
 *   ผู้ดูแลตั้งใจมาอ่านข้อมูลทั้งชุด ถ้าซ่อนช่องว่างไว้จะแยกไม่ออกว่า
 *   "ไม่มีข้อมูล" หรือ "ตัวเองมองข้ามไป"
 *
